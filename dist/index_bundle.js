 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(5);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(8);var _assign=__webpack_require__(3);var emptyFunction$1=__webpack_require__(2);var EventListener=__webpack_require__(9);var getActiveElement=__webpack_require__(10);var shallowEqual=__webpack_require__(11);var containsNode=__webpack_require__(12);var focusNode=__webpack_require__(13);var emptyObject=__webpack_require__(4);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(23);var camelizeStyleName=__webpack_require__(25);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _InputForm = __webpack_require__(29);
...
var Main = function (_React$Component) {
    ...
    function Main(props) {
        ...
        _this.SubmitFunc = _this.SubmitFunc.bind(_this);
        return _this;
    }

    _createClass(Main, [{
        key: 'SubmitFunc',
        value: function SubmitFunc(item) {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_MyTable2.default, { list: this.state.list }),
                _react2.default.createElement(_InputForm2.default, { submit: this.SubmitFunc })
            );
        }
    }]);
...
var _SingleChoice = __webpack_require__(30);

var _SingleChoice2 = _interopRequireDefault(_SingleChoice);
...
var InputForm = function (_React$Component) {
    ...
    function InputForm(props) {
        ...
        _this.resetMaritalStatus = function () {
            _this.setState({
                nameOfLover: "",
                loveDate: "",
                divorcedDate: ""
        ...
        _this.handleChange = function (label, value) {
            _this.setState(_defineProperty({}, label, value), function () {
                if (label === "maritalStatus") _this.resetMaritalStatus();
            });
        };
    ...
    _createClass(InputForm, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_SingleChoice2.default, {
                    label: 'Gender',
                ...
                _react2.default.createElement(_SingleChoice2.default, {
                    ...
                    optionList: [{ key: 'Single', value: 'single' }, { key: 'Married', value: 'married' }, { key: 'Divorced', value: 'divorced' }],
                    handleChange: this.handleChange,
                    value: user.maritalStatus,
                    variable: 'maritalStatus'
                }),
                user.maritalStatus === "married" || user.maritalStatus === "divorced" ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_Input2.default, {
                        label: 'Name of lover',
                ...
                user.maritalStatus === "divorced" && _react2.default.createElement(_Input2.default, {
                    label: 'Divorced date',
                    type: 'date',
                    handleChange: this.handleChange,
...
var SingleChoice = function (_React$Component) {
    _inherits(SingleChoice, _React$Component);

    function SingleChoice(props) {
        _classCallCheck(this, SingleChoice);

        var _this = _possibleConstructorReturn(this, (SingleChoice.__proto__ || Object.getPrototypeOf(SingleChoice)).call(this, props));

        _this.handleOptionChange = function (event) {
            _this.setState({
                choice: event.target.value
            }, _this.props.handleChange(_this.props.variable, event.target.value));
        };
